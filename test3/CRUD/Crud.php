...
//FUNCIONES 
 ...
 class ClaseCrud {
  ...
  public function deleteDireccion($iddireccion){
    $query = "DELETE FROM `tdireccion` WHERE `tdireccion`.`iddireccion` = $iddireccion";
    $link = ClaseConecta::conecta();
  ...
  public function deletePersona($rut){
    $query = "DELETE FROM `tpersona` WHERE `tpersona`.`rut` = '$rut'";
    $link = ClaseConecta::conecta();
    mysqli_query($link,$query);
    $nfilas = mysqli_affected_rows($link);
    return $nfilas;
  ...
  public function buscarIdfechahora($fecha, $hora){
    $query = "select tfechahora.idfechahora from tfechahora WHERE tfechahora.idfecha = '$fecha' and tfechahora.idhora = $hora";
    $link = ClaseConecta::conecta();
    //$array = mysqli_fetch_assoc(mysqli_query($link, $query));
    $array = mysqli_query($link, $query);
    //$direccion = $array['iddireccion'];
  ...
  public function buscarDisponibilidad($idfechahora, $especialista){
    $query = "Select d.iddisponibilidad from tdisponibilidad d where d.idfechahora = $idfechahora and d.idtrabaja = $especialista";
    $link = ClaseConecta::conecta();
    //$array = mysqli_fetch_assoc(mysqli_query($link, $query));
    $array = mysqli_query($link, $query);
    //$direccion = $array['iddireccion'];
  ...
  public function insertarReserva($iddisponibilidad,$rut){
    $query = "INSERT INTO `treserva`(iddisponiblidad, rut) VALUES ($iddisponibilidad,'$rut')";
    $link = ClaseConecta::conecta(); // cuando aparece claseConecta:: es un self.      
    mysqli_query($link, $query); //metodo de php que ejecuta sql, necesita la conexion y la consulta.
    $nfilas = mysqli_affected_rows($link); //metodo que devuelve la cantidad de filas insertadas, y necesita la conexion.
    return $nfilas;
  ...
  public function cambiarStatus($iddisponibilidad){
    $query = "UPDATE `tdisponibilidad` SET `idstatus` = '1' WHERE `tdisponibilidad`.`iddisponibilidad` = $iddisponibilidad";
    $link = ClaseConecta::conecta(); // cuando aparece claseConecta:: es un self.      
    mysqli_query($link, $query); //metodo de php que ejecuta sql, necesita la conexion y la consulta.
    $nfilas = mysqli_affected_rows($link); //metodo que devuelve la cantidad de filas insertadas, y necesita la conexion.
    return $nfilas;
  ...
  public function buscarReserva($rut){
    $query = "SELECT treserva.iddisponiblidad FROM `treserva` WHERE rut = '$rut'";
    $link = ClaseConecta::conecta();
    //$array = mysqli_fetch_assoc(mysqli_query($link, $query));
    $array = mysqli_query($link, $query);
    //$direccion = $array['iddireccion'];
  ...
  public function buscarIdfechahoradispo($iddisponibilidad){
    $query = "SELECT idfechahora FROM `tdisponibilidad` WHERE iddisponibilidad = $iddisponibilidad";
    $link = ClaseConecta::conecta();
    //$array = mysqli_fetch_assoc(mysqli_query($link, $query));
    $array = mysqli_query($link, $query);
    //$direccion = $array['iddireccion'];
  ...
  public function buscarIdfecha($idfechahora){
    $query = "SELECT idfecha FROM `tfechahora` WHERE tfechahora.idfechahora =$idfechahora";
    $link = ClaseConecta::conecta();
    //$array = mysqli_fetch_assoc(mysqli_query($link, $query));
    $array = mysqli_query($link, $query);
    //$direccion = $array['iddireccion'];
  ...
  public function buscarFecha($idfecha){
    $query = "SELECT `fecha` FROM `tfecha` WHERE tfecha.idfecha = $idfecha";
    $link = ClaseConecta::conecta();
    //$array = mysqli_fetch_assoc(mysqli_query($link, $query));
    $array = mysqli_query($link, $query);
    //$direccion = $array['iddireccion'];
