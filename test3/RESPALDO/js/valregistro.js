...
function validaSignupObligatorio(){
      ...
      var comunaPaciente           = document.getElementById('sel1').value;
      var regionPaciente           = document.getElementById('sel2').value;
    ...
    }else if (comunaPaciente == ""){           
        alert ("DEBE SELECCIONAR UNA COMUNA....");
        return false;
           
    }else if (regionPaciente == ""){           
        alert ("DEBE SELECCIONAR UNA REGION....");
        return false;
           
    }else if (saludPaciente == ""){       
